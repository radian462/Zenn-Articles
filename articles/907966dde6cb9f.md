...
個人的に一番おすすめなサービスです。無料枠の中では比較的スペックが良いです。
運営元がGoogleで廃止の心配が少ないのも評価高いです。
ただクラウドサービス全般に言えることですが、設定ミスると請求来るので気を付けて(3敗)
...
2025年3月ごろから60分で眠るようになったみたいです。[cron-job](https://cron-job.org/)などで眠らせないようにしましょう。
